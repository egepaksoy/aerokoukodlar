...
void loop() {
  ...
  if (data.indexOf("|") != -1) {
    int joystickXValue = data.substring(0, data.indexOf("|")).toInt(); // Joystick X değerini al
    int joystickYValue = data.substring(data.indexOf("|") + 1).toInt(); // Joystick Y değerini al
